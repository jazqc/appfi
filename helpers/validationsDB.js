...
var existEmail = function (email) { return __awaiter(void 0, void 0, void 0, function () {
    var existEmail;
...
var existUsername = function (username) { return __awaiter(void 0, void 0, void 0, function () {
    var existUsername;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, __1.prisma.user.findUnique({
            ...
            case 1:
                ...
                if (existUsername) {
                    throw new Error("El username ".concat(username, " ya est\u00E1 registrado"));
                }
                return [2 /*return*/];
        }
    });
