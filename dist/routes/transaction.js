...
router.post("/addTransaction", validateJWT_1.default, [
    ...
    (0, express_validator_1.check)("amout", 'el monto es obligatorio').not().isEmpty(),
    ...
    (0, express_validator_1.check)("category_id", "Debe asignarle una categoría").not().isEmpty(),
    (0, express_validator_1.check)("user_payment_method", "Debe asignarle un método de pago").not().isEmpty(),
